...
/**
 * Busca relatório de chamadas no período informado.
...
/**
 * Busca métricas das filas de atendimento.
 * @param {Date|string} dataInicio
 * @param {Date|string} dataFim
 * @returns {Promise<Object>}
 */
...
/**
 * Busca performance dos agentes no período.
 * @param {Date|string} dataInicio
 * @param {Date|string} dataFim
 * @returns {Promise<Object>}
 */
...
/**
 * Busca todos os dados necessários para o relatório diário.
 * @param {Date|string} data  — data de referência (padrão: hoje)
 * @returns {Promise<{chamadas, filas, agentes}>}
 */
